...
class A81aNoiseAssessment(ItemDisplay):
...
class A81aNutrientAssessment(ItemDisplay):
...
class A81aPhysicalDamageAssessment(ItemDisplay):
...
class A81aPhysicalLosAssessment(ItemDisplay):
...
class A81aPollutantEventAssessment(ItemDisplay):
